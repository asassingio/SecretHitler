...
public sealed class GameViewEliminationMenu : Menu
{
	...
	{
		PlayerController playerControllerThatWillDie = GameManager.Instance.GetPlayerByName(playerThatDieDropdown.captionText.text);
		string playerThatWillDieName = playerControllerThatWillDie.ServerGetName();
